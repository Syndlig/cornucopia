...
public class OrchardTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private final BlockState LOG;
   private final BlockState LEAF;
   private final boolean useExtraRandomHeight;

   public OrchardTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, BlockOrchardLog log, BlockOrchardLeaves leaves, boolean doBlockNotifyIn, boolean extraRandomHeightIn) {
      super(configIn, doBlockNotifyIn);
      LOG = log.getDefaultState();
      LEAF = leaves.getDefaultState();
